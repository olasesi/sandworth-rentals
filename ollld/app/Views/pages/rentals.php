    ...
    <div class="results-panel" id="results-list-rentals">
        ...
        <div class="results-header">
            ...
            <div class="topbar-actions">
                ...
                <a class="ghost-button" href="<?= htmlspecialchars(app_url('manager'), ENT_QUOTES, 'UTF-8') ?>">Landlord view</a>
            </div>
        </div>
                ...
                <article class="result-card" data-listing-id="<?= (int) $listing['id'] ?>">
                    ...
                    <div class="result-card-body">
                        ...
                        <div class="result-actions">
                            ...
                            <a class="text-link" href="<?= htmlspecialchars(app_url('property', array('id' => $listing['id'])), ENT_QUOTES, 'UTF-8') ?>">See listing &rarr;</a>
                        </div>
                    </div>
                </article>
            <?php endforeach; ?>
