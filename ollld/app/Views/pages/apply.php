...
<section class="page-hero compact">
    <div>
        ...
        <p>
            ...
            <?php else: ?>
                Complete the application so the admin team can review, approve, and unlock online move-in payment.
            <?php endif; ?>
        </p>
    </div>
</section>
            ...
            <div style="display:grid; gap:8px; font-size:.875rem">
                ...
                <?php else: ?>
                    ...
                    <div style="display:flex; justify-content:space-between; padding:6px 0">
                        ...
                        <strong><?= htmlspecialchars(app_currency($listing['securityDeposit']), ENT_QUOTES, 'UTF-8') ?></strong>
                    </div>
                <?php endif; ?>
            </div>
        </div>
