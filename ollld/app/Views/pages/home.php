...
<section class="hero">
    <div class="hero-copy">
        ...
        <div class="stat-grid">
            <article>
                <strong><?= number_format($stats['activeRentals']) ?>+</strong>
                <span><?= htmlspecialchars((string) $activeRentalsLabel, ENT_QUOTES, 'UTF-8') ?></span>
            </article>
            <article>
                <strong><?= number_format($stats['preQualifiedRenters']) ?>+</strong>
                <span><?= htmlspecialchars((string) $preQualifiedRentersLabel, ENT_QUOTES, 'UTF-8') ?></span>
            </article>
            <article>
                <strong><?= (int) $stats['avgDaysToLease'] ?> days</strong>
                <span><?= htmlspecialchars((string) $avgDaysToLeaseLabel, ENT_QUOTES, 'UTF-8') ?></span>
            </article>
        </div>
    </div>
</section>
...
<?php if ($marketSpotlights !== array()): ?>
    <section class="section-block market-section">
        <div class="section-heading">
            <div>
                <span class="eyebrow">Browse by market</span>
            ...
            <?php foreach ($marketSpotlights as $market): ?>
                ...
                <a class="market-card" href="<?= htmlspecialchars($marketLink, ENT_QUOTES, 'UTF-8') ?>">
                    ...
                    <div class="market-card-body">
                        <span class="eyebrow">Market spotlight</span>
    ...
    <section class="section-block fresh-listings-section">
        ...
        <div class="market-listing-grid">
            <?php foreach (array_slice($freshListings, 0, 6) as $listing): ?>
                ...
                ?>
                <a class="market-listing-card" href="<?= htmlspecialchars(app_url('property', array('id' => $listing['id'])), ENT_QUOTES, 'UTF-8') ?>">
                    <div class="market-listing-media">
                    ...
                    <div class="market-listing-body">
                        ...
                        <span class="market-listing-link">Open property details</span>
                    </div>
                </a>
            <?php endforeach; ?>
        </div>
    ...
    <section class="section-block">
        ...
        <div class="listing-grid">
            <?php foreach ($featuredHomes as $listing): ?>
                <a class="listing-card listing-card-link" href="<?= htmlspecialchars(app_url('property', array('id' => $listing['id'])), ENT_QUOTES, 'UTF-8') ?>">
                    <img src="<?= htmlspecialchars((string) $listing['image'], ENT_QUOTES, 'UTF-8') ?>" alt="<?= htmlspecialchars((string) $listing['title'], ENT_QUOTES, 'UTF-8') ?>">
                    <div class="listing-body">
                        ...
                        <span class="market-listing-link">View details</span>
                    </div>
                </a>
            <?php endforeach; ?>
        </div>
            ...
            <?php foreach ($featuredRentals as $listing): ?>
                <a class="listing-card listing-card-link" href="<?= htmlspecialchars(app_url('property', array('id' => $listing['id'])), ENT_QUOTES, 'UTF-8') ?>">
                    ...
                    <div class="listing-body">
                        ...
                        <p><?= htmlspecialchars((string) $listing['location'], ENT_QUOTES, 'UTF-8') ?></p>
                        <span class="market-listing-link">View rental details</span>
                    </div>
                </a>
            <?php endforeach; ?>
        </div>
            ...
            <?php foreach (array_slice($featuredCommercial, 0, 3) as $listing): ?>
                <a class="listing-card listing-card-link" href="<?= htmlspecialchars(app_url('property', array('id' => $listing['id'])), ENT_QUOTES, 'UTF-8') ?>">
                    ...
                    <div class="listing-body">
                        ...
                        <h3><?= htmlspecialchars((string) $listing['title'], ENT_QUOTES, 'UTF-8') ?></h3>
                        <p><?= htmlspecialchars((string) $listing['location'], ENT_QUOTES, 'UTF-8') ?></p>
                        <span class="market-listing-link">View listing</span>
                    </div>
                </a>
            <?php endforeach; ?>
        </div>
