...
<section class="results-list" style="padding-bottom:32px">
        ...
        <article class="result-card">
            ...
            <div class="result-card-body">
                ...
                <div class="result-actions">
                    ...
                    <a class="text-link" href="<?= htmlspecialchars(app_url('property', array('id' => $listing['id'])), ENT_QUOTES, 'UTF-8') ?>">See rental</a>
                </div>
            </div>
        </article>
    <?php endforeach; ?>
    ...
    <section class="section-block">
        ...
        <div class="chip-row">
            <?php foreach ($nearbyMarkets as $nearby): ?>
                <a class="ghost-button" href="<?= htmlspecialchars(app_url('city-rentals', array('market' => $nearby)), ENT_QUOTES, 'UTF-8') ?>">
