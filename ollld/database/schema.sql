...
CREATE TABLE IF NOT EXISTS tour_requests (
    ...
    requested_date VARCHAR(120) NOT NULL DEFAULT '',
    requested_time VARCHAR(120) NOT NULL DEFAULT '',
    notes TEXT NULL,
    scheduled_date VARCHAR(120) NOT NULL DEFAULT '',
    scheduled_time VARCHAR(120) NOT NULL DEFAULT '',
    attended_by VARCHAR(150) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS activity_log (
    ...
    KEY activity_log_entity_idx (entity_type, entity_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
